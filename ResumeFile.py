...
ResumeLabel = Label(ResumeWindow , text="Enter The File Name:(suffix not needed)" , fg="purple")
ResumeLabel.pack()
...
ResumeButtom1 = Button(ResumeWindow , text="CONFIRM" , width=15 , height = 2 , command=GetFileName , bg="yellow" , fg="red")
ResumeButtom1.pack()
